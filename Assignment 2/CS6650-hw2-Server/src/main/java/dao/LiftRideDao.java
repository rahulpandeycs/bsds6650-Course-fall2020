...
//      SkierCompositeKey skierCompositeKey = new SkierCompositeKey(liftRide.getResortID(),
//              liftRide.getDayID(), liftRide.getSkierID(), liftRide.getTime());
//      if (session.get(LiftRide.class, skierCompositeKey) != null) {
////        session.update(liftRide); //update if already exists
//        updateLiftRide(liftRide);
//      } else
